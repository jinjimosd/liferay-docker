...
function build_docker_image {
	...
	DOCKER_IMAGE_TAGS=()
	DOCKER_IMAGE_TAGS+=("${LIFERAY_DOCKER_REPOSITORY}hieunn08/liferay-base:${image_version}-${TIMESTAMP}")
	DOCKER_IMAGE_TAGS+=("${LIFERAY_DOCKER_REPOSITORY}hieunn08/liferay-base")
...
function main {
	delete_local_images "hieunn08/liferay-base"
