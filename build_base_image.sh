...
function build_docker_image {
	...
	DOCKER_IMAGE_TAGS=()
	DOCKER_IMAGE_TAGS+=("${LIFERAY_DOCKER_REPOSITORY}jinjimosd/liferay-base:${image_version}-${TIMESTAMP}")
	DOCKER_IMAGE_TAGS+=("${LIFERAY_DOCKER_REPOSITORY}jinjimosd/liferay-base")
...
function main {
	delete_local_images "jinjimosd/liferay-base"
